...
# : Delete this import if you choose not to use it. Delete this comment when you are done.
import sys
...
class Vertex:
    ...
    @property
    def depth(self):
        """Property to get the depth of the vertex. This is the number of pre
...
class Graph:
    ...
    def has_cycle(self):
        ...
        """
        def dfs(index, visited, stack):
            visited[index] = True
            stack[index] = True

            for n_index, edge in enumerate(self.adjacency_matrix[index]):
                if edge > 0:
                    if not visited[n_index]:
                        if dfs(n_index, visited, stack):
                            return True
                    elif stack[n_index]:
                        return True
